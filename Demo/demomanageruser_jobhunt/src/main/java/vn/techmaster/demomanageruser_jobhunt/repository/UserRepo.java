...
public class UserRepo {
  ...
  public User addUser(String fullname, String email, String hashed_pass){
      return addUser(fullname, email, hashed_pass, State.PENDING, Roles.MEMBER);
  }

  public User addUser(String fullname, String email, String hashed_pass, State state, Roles role){
